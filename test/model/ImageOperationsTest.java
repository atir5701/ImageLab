...
public class ImageOperationsTest {
  ...
  public void setUp() throws Exception {
    ...
    this.reference = this.getMatrix(file);
    this.operations.loadImages(this.reference, "man");
  }
  ...
  public void checkBrightness() {
    ...
    int[][][] manNew = this.operations.getImage("man-bright-50");
  ...
  public void checkDarkeness() {
    ...
    int[][][] manNew = this.operations.getImage("man-darken-50");
    String file = "D:\\Northeastern\\PDP\\Assignment-4-MVC\\images" +
  ...
  public void checkVerticalFlip() {
    ...
    int[][][] manNew = this.operations.getImage("man-vflip");
    String file = "D:\\Northeastern\\PDP\\Assignment-4-MVC\\images" +
  ...
  public void checkHorizontalFlip() {
    ...
    int[][][] manNew = this.operations.getImage("man-hflip");
    String file = "D:\\Northeastern\\PDP\\Assignment-4-MVC\\images" +
  ...
  public void checkHorizontalVerticalFlip() {
    ...
    int[][][] manNew = this.operations.getImage("man-hv");
    String file = "D:\\Northeastern\\PDP\\Assignment-4-MVC\\images" +
  ...
  public void checkVerticalHorizontalFlip() {
    ...
    int[][][] manNew = this.operations.getImage("man-vh");
    String file = "D:\\Northeastern\\PDP\\Assignment-4-MVC\\images" +
  ...
  public void checkSepia() {
    ...
    int[][][] manNew = this.operations.getImage("man-sepia");
    String file = "D:\\Northeastern\\PDP\\Assignment-4-MVC\\images" +
  ...
  public void checkBlur() {
    ...
    int[][][] manNew = this.operations.getImage("man-blur");
    String file = "D:\\Northeastern\\PDP\\Assignment-4-MVC\\images" +
  ...
  public void checkSharpen() {
    ...
    int[][][] manNew = this.operations.getImage("man-sharp");
    String file = "D:\\Northeastern\\PDP\\Assignment-4-MVC\\images" +
  ...
  public void checkValueComponent() {
    ...
    int[][][] manNew = this.operations.getImage("man-value");
    String file = "D:\\Northeastern\\PDP\\Assignment-4-MVC\\images" +
  ...
  public void checkLumaComponent() {
    ...
    int[][][] manNew = this.operations.getImage("man-luma");
    String file = "D:\\Northeastern\\PDP\\Assignment-4-MVC\\images" +
  ...
  public void checkIntensityComponent() {
    ...
    int[][][] manNew = this.operations.getImage("man-intensity");
    String file = "D:\\Northeastern\\PDP\\Assignment-4-MVC\\images" +
  ...
  public void checkRedComponent() {
    this.operations.getColorComponent("man",
            "man-red", 0);
    int[][][] manNew = this.operations.getImage("man-red");
    String file = "D:\\Northeastern\\PDP\\Assignment-4-MVC\\images" +
  ...
  public void checkBlueComponent() {
    this.operations.getColorComponent("man",
            "man-blue", 2);
    int[][][] manNew = this.operations.getImage("man-blue");
    String file = "D:\\Northeastern\\PDP\\Assignment-4-MVC\\images" +
  ...
  public void checkGreenComponent() {
    this.operations.getColorComponent("man",
            "man-green", 1);
    int[][][] manNew = this.operations.getImage("man-green");
    String file = "D:\\Northeastern\\PDP\\Assignment-4-MVC\\images" +
  ...
  public void checkRGBSplit() {
    ...
    manNew = this.operations.getImage("man-green");
    ...
    manNew = this.operations.getImage("man-blue");
    file = "D:\\Northeastern\\PDP\\Assignment-4-MVC\\images" +
            "\\manhattan-small-blue.png";
    compare = this.getMatrix(file);
    for (int i = 0; i < manNew.length; i++) {
  ...
  public void checkRGBCombine() {
    ...
    this.operations.combineRGB("man-red", "man-green",
            "man-blue", "manNew");
    int[][][] manNew = this.operations.getImage("manNew");
    String file = "D:\\Northeastern\\PDP\\Assignment-4-MVC\\images" +
            "\\manhattan-small.png";
    int[][][] compare = this.getMatrix(file);
    for (int i = 0; i < manNew.length; i++) {
