...
class Sharpen extends AbstractCommandExecuter {
  ...
  /**
   * Constructs a Sharpen command object.
   ...
   * which is obtained as a result of sharpen operation on original image.
  ...
  public boolean execute(OperationsV3 operations) {
    ...
    if (this.percentage == 100.00 && this.maskImageName == null) {
      ...
      if (this.maskImageName != null) {
        ...
        boolean t = operations.sharpen(this.currentImageName, temp);
